...
export function MapControls({ zoom, pitch, bearing, onZoomChange, onPitchChange, onBearingChange }: MapControlsProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 border rounded-lg bg-muted/50">
      <div className="space-y-2">
        ...
        <Slider id="zoom" min={0} max={20} step={0.5} value={zoom} onValueChange={onZoomChange} />
      </div>
      ...
      <div className="space-y-2">
        ...
        <Slider id="pitch" min={0} max={85} step={1} value={pitch} onValueChange={onPitchChange} />
      </div>
      ...
      <div className="space-y-2">
        ...
        <Slider id="bearing" min={-180} max={180} step={1} value={bearing} onValueChange={onBearingChange} />
      </div>
    </div>
  )
}
