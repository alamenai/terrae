  ...
  return (
    ...
    >
      ...
      <DocsSection title="Multiple Lines">
        <p>
          Animate multiple lines simultaneously by adding multiple <DocsCode>MapAnimatedLine</DocsCode> components. Each
          line can have different colors, durations, and start times.
        </p>
      </DocsSection>
      ...
      <DocsSection title="Custom Marker Icons">
        <p>
          ...
          <DocsCode>markerIcon</DocsCode> prop. This example shows four parallel routes with rocket icons moving in the
          same direction.
        </p>
      </DocsSection>
      ...
      <ComponentPreview code={cyclistSource}>
        <CyclistRouteExample />
      </ComponentPreview>
        ...
        <div className="rounded-md border">
          <Table>
            ...
            <TableBody>
              ...
              <TableRow>
                <TableCell>
                  <DocsCode>markerBorderless</DocsCode>
                </TableCell>
                <TableCell className="text-muted-foreground">boolean</TableCell>
                <TableCell className="text-muted-foreground">false</TableCell>
                <TableCell>Remove border/outline from marker</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
      ...
      <DocsSection title="Performance Tips">
        <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground mt-2">
          ...
          <li>
            Disable marker with <DocsCode>showMarker=false</DocsCode> for better performance
          </li>
          <li>
            Consider using <DocsCode>autoStart=false</DocsCode> and trigger manually
          </li>
        </ul>
      </DocsSection>
    </DocsLayout>
...
export default AnimatedLinesPage
