...
export default function IdeasPage() {
  ...
  return (
    <>
      <h1 className="text-4xl font-bold tracking-tight mb-4">Ideas</h1>
        ...
        >
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="text-xl font-semibold group-hover:text-primary transition-colors">Suggest Your Idea</h3>
