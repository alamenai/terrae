  ...
  return (
    ...
    >
      ...
      <DocsSection title="Avatar Markers">
        <p>
          Use <DocsCode>MarkerAvatar</DocsCode> to display user avatars or profile images on the map. Perfect for showing team members, online users, or contributor locations with status indicators.
        </p>
      </DocsSection>
