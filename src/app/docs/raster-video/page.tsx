...
export default function VideoPage() {
  ...
  return (
    <DocsLayout
      ...
      prev={{ title: "Music Disc", href: "/docs/music-disc" }}
    ...
    >
      <DocsSection title="Installation">
        ...
        <CodeBlock code={`npx shadcn@latest add https://www.terrae.dev/raster-video.json`} language="bash" />
        <p className="mt-2">
          Use the <DocsCode>useVideoControl</DocsCode> hook to control video playback with play, pause, and toggle
          functions.
        </p>
      </DocsSection>
      ...
      <DocsSection title="Playback Control Hook">
        ...
        <CodeBlock
          code={`import { useVideoControl } from "@/registry/map";
  ...
  return (
    <button onClick={toggle}>
      ...
      <DocsSection title="Coordinate Format">
        <p>The coordinates array must contain exactly four corner points in this order:</p>
      ...
      <DocsSection title="Video Format Support">
        <div className="rounded-md border">
          <Table>
            ...
            <TableBody>
              ...
              <TableRow>
                <TableCell>
                  <DocsCode>WebM (VP8/VP9)</DocsCode>
                </TableCell>
        ...
        <p className="mt-3 text-sm text-muted-foreground">
          Provide multiple formats for browser compatibility. Videos should be optimized for web playback with
          appropriate compression and resolution.
        </p>
      </DocsSection>
